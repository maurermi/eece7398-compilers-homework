; ModuleID = 'tests/sqrt.c'
source_filename = "tests/sqrt.c"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128"
target triple = "arm64-apple-macosx15.0.0"

@.str = private unnamed_addr constant [25 x i8] c"Square root of %f is %f\0A\00", align 1
...
define i32 @main() #0 {
  ...
  store float 1.600000e+01, ptr %2, align 4
  ...
  %12 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %9, double noundef %11)
  ret i32 0
}
